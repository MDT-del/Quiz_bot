...
if (!$userId || !$amount || !$orderId || !$merchantCode || !$replitAppUrl) {
    header("Content-Type: text/html; charset=UTF-8");
    die("<h1>خطا: اطلاعات ارسالی ناقص است. لطفاً از طریق ربات اقدام کنید.</h1>");
}

// آدرس بازگشت باید به اسکریپت verify.php اشاره کند
$callbackUrl = $replitAppUrl . '/payment/verify.php?order_id=' . $orderId . '&amount=' . $amount;
